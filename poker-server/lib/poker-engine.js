...
class PokerEngine extends EventEmitter {
  ...
  updateSettings(opts) {
    ...
    if (opts.smallBlind !== undefined && opts.smallBlind > 0) this.smallBlind = opts.smallBlind;
    if (opts.bigBlind !== undefined && opts.bigBlind > 0) this.bigBlind = opts.bigBlind;
  ...
  _dealerIdx() {
    return this.seatOrder.findIndex(name => this.players.get(name)?.seat === this.dealerSeat);
  }
