 ...
 *
 * Files written (in bot_profiles/<name>/):
...
const PROFILE_DIR  = path.join(PROJECT_ROOT, 'bot_profiles', CONFIG.name);
...
function logEvent(event) {
  ...
  // Rotate file after MAX_HANDS_PER_FILE hands
  if (event.type === 'hand_start') {
    if (historyHandCount >= MAX_HANDS_PER_FILE) {
