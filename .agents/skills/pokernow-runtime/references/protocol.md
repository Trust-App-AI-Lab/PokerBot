...
For quick reference, see `../ARCHITECTURE.md`. This file has the protocol details.
...
| `PLAYER_SIT_BACK` | — | Sit back into the same seat after sitting out |
| `QNH` | `"socket": true` | Queue sitting out / leaving the next hand |
