...
class PokerNowClient extends EventEmitter {
  ...
  constructor({ gameUrl, botName = 'ARIA_Bot', logger, workDir, profileDir, cookieFile }) {
    ...
    // Bot profile directory: explicit > auto (PokerBot/.claude/skills/bot-management/bots/{botName}/)
    this.profileDir = profileDir || path.join(this.workDir, '.claude', 'skills', 'bot-management', 'bots', botName);
