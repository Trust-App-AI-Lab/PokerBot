...
`);
  ...
  const TABLE_HTML_PATH = path.join(__dirname, '..', '..', '..', '.claude', 'skills', 'poker-server', 'public', 'poker-table.html');
  ...
  const httpServer = http.createServer((req, res) => {
    ...
    if (req.method === 'GET' && req.url === '/state') {
      ...
      if (state) {
        // Mark isMyTurn from turn file (fields already in state from getClaudeContext)
